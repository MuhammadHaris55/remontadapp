...
import 'package:remontada/features/creates/add_teams.dart';

class CreateTeams extends StatelessWidget {
  const CreateTeams({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomRectangularTextFormField(hintText: 'Discription'),
                    SizedBox(
                      height: 24.h,
                    ),
                    const CustomTextFormFieldIcon(hintText: 'Invite Friends'),
                    SizedBox(
                      height: 100.h,
                    ),
                    Row(
