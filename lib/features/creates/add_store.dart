...
import 'package:remontada/features/creates/add_product.dart';
            ...
            Container(
              child: Padding(
                ...
                child: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    CustomRectangularTextFormField(hintText: 'Store Name'),
                    ...
                    SizedBox(height: 24.0.h),
                    const CustomTextFormFieldIcon(hintText: 'Add Products'),
