...
class FindTrainer extends StatefulWidget {
  const FindTrainer({super.key});

  @override
  State<FindTrainer> createState() => _FindTrainerState();
}

class _FindTrainerState extends State<FindTrainer> {
                    ...
                    return Card(
                      ...
                      child: Column(children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/find_trainer.png',
                            fit: BoxFit.cover,
                            height: 255.0.h,
                            width: 396.w,
                          ),
